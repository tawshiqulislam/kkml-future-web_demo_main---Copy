    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="green_web">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="GREEN_WEB_API_TOKEN">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('GREEN WEB API TOKEN')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="GREEN_WEB_API_TOKEN"
                                       value="{{  env('GREEN_WEB_API_TOKEN') }}" placeholder="GREEN WEB API TOKEN"
                                       required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
