                    ...
                    <div class="d-inline-block d-md-block">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <div class="form-group mb-0">
                                <input type="email" class="form-control" style="border-radius:.4rem 0 0 .4rem;"
                                       placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                            <button type="submit" class="btn btn-primary" style="border-radius:0 .4rem .4rem 0;">
                                {{ translate('Subscribe') }}
                            </button>
                        </form>
                    </div>
                ...
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        @if (Auth::check())
                            ...
                            <li class="mb-2">
                                <a href="{{ route('customer_membership_dashboard') }}" class="opacity-50 hov-opacity-100 text-reset">{{ translate('Membership')}}</a>
                            </li>
                            @else
                            {{-- <li class="mb-2">
                                <a href="{{ route('customer_membership_request') }}" class="opacity-50 hov-opacity-100 text-reset">{{ translate('Become member')}}</a>
                            </li> --}}
                        @endif
                        @else
                            {{-- <li class="mb-2">
                                <a href="{{ route('customer_membership_reg') }}" class="opacity-50 hov-opacity-100 text-reset">{{ translate('Become member')}}</a>
                            </li> --}}
                            <li class="mb-2">
