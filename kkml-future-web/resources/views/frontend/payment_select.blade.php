                                ...
                                <div class="row">
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                            ...
                                            @if(\App\BusinessSetting::where('type', 'smanager_payment')->first()->value == 1)
                                                <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="smanager" class="online_payment" type="radio"
                                                               name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/smanager.png')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('sManager Payment Method')}}</span>
                                                        </span>
                                                    </span>
                                                    </label>
                                                </div>
