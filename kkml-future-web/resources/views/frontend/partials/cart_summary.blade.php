<div class="card border-0 shadow-sm rounded">
    <div class="card-header">
        ...
        <div class="text-right">
            <span
                class="badge badge-inline badge-primary">{{ count(Session::get('cart')->where('owner_id', Session::get('owner_id'))) }} {{translate('Items')}}</span>
        </div>
    </div>
        ...
        <table class="table">
            ...
            <tr class="cart-shipping">
                ...
                <td class="text-right">
                    ...
                    <br/>
                    <small class="text-muted">Maximum Shipping cost of product</small>
                </td>
            </tr>
            ...
            @else
                @if(Auth::user()->point_balance > 0)
                    <div class="mt-3">
                        ...
                        <form class="" action="{{ route('checkout.apply_club_point') }}" method="POST"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="input-group">
