<section class="mb-4">
    <div class="container">
        <div class="px-3 py-3 bg-white shadow-sm rounded">
            <div class="d-flex mb-3 align-items-baseline section-title border-bottom">
                <h3 class="h5 fw-700 mb-0">
                    <span
                        class="border-bottom border-primary border-width-2 pb-md-3 pb-2 d-inline-block">{{ translate('Featured Products') }}</span>
                </h3>
            </div>
            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"
                ...
                @foreach (filter_products(\App\Product::where('published', 1)->where('featured', '1'))->limit(12)->get() as $key => $product)
                    <div class="carousel-box">
                        ...
                        <div class="aiz-card-box rounded hov-shadow-md my-2 has-transition" data-toggle="tooltip"
                            data-placement="right" title="{{ $product->getTranslation('name') }}">
