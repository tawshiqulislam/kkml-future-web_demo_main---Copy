                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('products.brand', $detailedProduct->brand->slug) }}">
                                            ...
                                            data-src="{{ uploaded_asset($detailedProduct->brand->logo) }}"
                                                 ...
                                                 height="30">
                                                 <span>{{ $detailedProduct->brand->getTranslation('name') }}</span>
                                        </a>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fs-20 opacity-60">
                                            ...
                                            @php
                                              $flash_deal_product = flash_deal_product($detailedProduct->id);
                                            @endphp
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-sm-2">
                                                <div
                                                    class="opacity-50 my-2">{{ \App\Attribute::find($choice->attribute_id)->getTranslation('name') }}
                                                    :
                                                </div>
                                            </div>
                                            <div class="col-sm-10">
                            ...
                            <div class="mt-3">
                                @if ($qty > 0)
                                    <button type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600"
                                        ...
                                        <span
                                            class="d-md-inline-block"> {{ translate('Add to cart') }}</span>
                                    </button>
                    ...
                    <div class="bg-white mb-3 shadow-sm rounded">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                    <div class="mw-100 overflow-hidden text-left product-details-content">
                            ...
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3"
                                ...
                                @foreach (filter_products(\App\Product::where('category_id', $detailedProduct->category_id)->where('id', '!=', $detailedProduct->id))->limit(10)->get() as $key => $related_product)
                                    <div class="carousel-box">
                                        <div
                                            class="aiz-card-box rounded hov-shadow-md has-transition" data-toggle="tooltip" data-placement="right" title="{{ $related_product->getTranslation('name') }}">
                                            <div class="">
