...
{{--                                                    <div>--}}
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            class="fw-600 ml-2">{{ $address->city }}, {{ $address->country }}</span>
                                                    </div>
...
{{--                                                    <div>--}}
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-center text-md-right">
                                <button type="submit"
                                        class="btn btn-primary fw-600">{{ translate('Continue to Delivery Info')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <input name="country" value="Bangladesh" type="hidden"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3" placeholder="{{ translate('+880')}}"
                                           name="phone" value="{{$_phone}}" required>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col">
                                    <input type="checkbox" name="default" value="1"> &emsp;
                                    <label>{{ translate('Mark as default shipping address')}}</label>
                                </div>
                            </div>
                        </div>
                    </div>
