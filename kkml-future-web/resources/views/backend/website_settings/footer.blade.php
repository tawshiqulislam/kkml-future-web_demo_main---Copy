        ...
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            @if($is_texon ?? false)   <label>{{ translate('Copyright Text') }}</label> @endif
                            ...
                            @else
                                <textarea name="frontend_copyright_text"
                                          hidden> @php echo get_setting('frontend_copyright_text'); @endphp</textarea>
                            @endif
                        </div>
                    </div>
                </div>
