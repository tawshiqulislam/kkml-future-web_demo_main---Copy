...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Edit Service')}}</h5>
</div>
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('service.update')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" value="{{$service->name}}" placeholder="{{ translate('Service Name') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        <div class="form-group row" id="category">
                            <label class="col-md-3 col-from-label">{{translate('Category')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="service_category_id" id="category_id" data-live-search="true" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="file-preview box sm">
                                    @if($category->image!='')
                                    <img src="{{ uploaded_asset($service->thumbnail_img) }}" alt="{{translate('image')}}" height="70px" width="70px">
                                    @else
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="{{$service->video_link}}" name="video_link" placeholder="{{ translate('Video Link') }}">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Contact Address')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Contact Info.')}}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="address">{{$service->address}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
