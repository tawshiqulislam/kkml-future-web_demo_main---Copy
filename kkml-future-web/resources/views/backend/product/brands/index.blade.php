...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="align-items-center">
			<h1 class="h3">{{translate('All Brands & Authors')}}</h1>
	</div>
</div>
		...
		<div class="card">
		    <div class="card-header row gutters-5">
				<div class="col text-center text-md-left">
					<h5 class="mb-md-0 h6">{{ translate('Brands/Authors') }}</h5>
				</div>
				<div class="col-md-4">
	...
	<div class="col-md-5">
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{ translate('Add New Brand/Author') }}</h5>
			</div>
			<div class="card-body">
				<form action="{{ route('brands.store') }}" method="POST">
					...
					<div class="form-group mb-3">
						<label for="name">{{translate('Logo/Photo')}} <small>({{ translate('120x80') }})</small></label>
					...
					<div class="form-group mb-3">
						<label for="name">{{translate('Is That a Author?')}}</label>
						<input type="checkbox" class="my-4" name="isauthor" value="1">
					</div>
