        ...
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                @if(get_setting('system_logo_white') != null)
                    <img src="{{ uploaded_asset(get_setting('system_logo_white')) }}" class="brand-icon mw-100"
                         alt="{{ get_setting('site_name') }}">
                @else
                    <img src="{{ static_asset('assets/img/logo.png') }}" class="brand-icon mw-100"
                         alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('brands.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Brand/Author')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
            ...
            <!--OTP addon -->
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('custom-pages.edit', ['id'=>"home",  'lang'=>env('DEFAULT_LANGUAGE'), 'page'=>'home'] )}}"
                       class="aiz-side-nav-link">
                        <i class="las la-horse aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">Home Slider</span>
                    </a>
                </li>
