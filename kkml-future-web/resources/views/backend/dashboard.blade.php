        ...
        <div class="row gutters-10">
            <div class="col-lg-6">
                <div class="row gutters-10">
                    ...
                    <div class="col-6">
                        <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3 d-flex">
                                ...
                                <div class="col p-0 text-right">
                                    <a class="btn btn-light btn-icon btn-circle btn-sm"
                                        href="{{ route('export.category') }}" title="{{ translate('Download Report') }}">
                                        <i class="las la-download"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3 d-flex">
                                ...
                                <div class="col p-0 text-right">
                                    <a class="btn btn-light btn-icon btn-circle btn-sm" href="{{ route('export.brand') }}"
                    ...
                    <div class="col-12">
                        <div class="bg-grad-2 text-white bg-success rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3 d-flex justify-content-between">
                                <div class="float-left">
                                    <div class="col-md">
                                        <div class="h6 d-block opacity-50 ">{{ translate("Today's Sale:") }}</div>
                                        <div class="h4 d-block">{{ \App\Order::whereDate('created_at', today())->count() }}
                                        </div>
                                    </div>
                                </div>
                                <div class="float-right">
                                    <div class="col-md">
                                        <div class="h6 d-block opacity-50 ">{{ translate('Total:') }}</div>
                                        <div class="h4 d-block">
                                            {{ \App\Order::whereDate('created_at', today())->sum('grand_total') }} &#2547;</div>
                                    </div>
                                </div>
                                <div class="float-right">
                                    <div class="col-md">
                                        <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                            href="{{ route('export.todays_sale') }}"
                                            title="{{ translate('Download Report') }}">
                                            <i class="las la-download"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex p-0">
                                ...
                                <div class="col text-right">
                                    <a class="btn btn-info btn-icon btn-circle btn-sm" href="{{ route('export.product') }}"
                                        title="{{ translate('Download Report') }}">
                                        <i class="las la-download" style="width: 80%"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
                                <canvas id="pie-1" class="w-100" height="350"></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="pie-2" class="w-100" height="350"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
