...
use App\Http\Middleware\TexonAuth;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/services', 'ServiceController@index')->name('service.all');
    ...
    Route::post('/services/published', 'ServiceController@updatePublished')->name('service.published');
    Route::get('/services/destroy/{id}', 'ServiceController@delete')->name('service.destroy');

    Route::get('/services/order/{id?}', 'ServiceOrderController@service_order')->name('service_order');
    Route::get('/services/order/complete/{id}', 'ServiceOrderController@service_order_accept')->name('service_order.accept');
    Route::get('/services/order/reject/{id}', 'ServiceOrderController@service_order_reject')->name('service_order.reject');

    Route::get('/services/category', 'ServiceCategoryController@index')->name('service_category.all');
    Route::get('/services/category/create', 'ServiceCategoryController@create')->name('service_category.create');
    Route::post('/services/category/store', 'ServiceCategoryController@store')->name('service_category.store');
    Route::post('/services/category/update/{id}', 'ServiceCategoryController@update')->name('service_category.update');
    Route::get('/services/category/edit/{id}', 'ServiceCategoryController@edit')->name('service_category.edit');
    Route::get('/services/category/delete/{id}', 'ServiceCategoryController@delete')->name('service_category.destroy');

    Route::get('/export/todays_sale', 'ExportController@export_todays_sale')->name('export.todays_sale');
    Route::get('/export/brand', 'ExportController@export_brand')->name('export.brand');
    Route::get('/export/category', 'ExportController@export_category')->name('export.category');
    Route::get('/export/order', 'ExportController@export_order')->name('export.order');
    Route::get('/export/product', 'ExportController@export_product')->name('export.product');
    ...
    Route::get('membership', 'MembershipController@index')->name('member.all');
    Route::get('membership/pending', 'MembershipController@pending')->name('member.pending');
    Route::get('membership/reject', 'MembershipController@reject')->name('member.reject');
    Route::get('membership/{id?}/{parameter?}', 'MembershipController@member_op')->name('member.op');
    ...
    Route::group(['middleware' => TexonAuth::class], function () {
