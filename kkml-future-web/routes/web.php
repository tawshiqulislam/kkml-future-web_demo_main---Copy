...
Route::post('/demo/cron_1', 'DemoController@cron_1')->name('test_1.demo');
...
Route::get('/home/section/ajax_all_product', 'HomeController@paginate_all_product')->name('home.section.ajax_all');
Route::post('/home/section/all_product', 'HomeController@load_all_product_section')->name('home.section.all');
Route::get('/home/section/all_service', 'HomeController@load_all_service')->name('home.service.all');
...
Route::post('/home/section/slide_by_category/{category}', 'HomeController@slide_by_category')->name('home.section.product_slider_by_cat');
...
Route::get('/all-products', 'CustomerProductController@customer_products_listing')->name('customer.products');
...
Route::get('/service/{id}', 'HomeController@service')->name('service.view');
Route::post('/service/appoint', 'HomeController@service_appoint')->name('service.appoint');
...
Route::get('/authors', 'HomeController@all_authors')->name('authors.all');
...
Route::get('/membership/reg', 'MembershipController@reg')->name('customer_membership_reg');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::get('/membership', 'MembershipController@dashboard')->name('customer_membership_dashboard');
    Route::get('/membership/join', 'MembershipController@join')->name('customer_membership_request');
    Route::post('/membership/store', 'MembershipController@store')->name('membership.create');
    Route::get('/membership/cancel/{id}', 'MembershipController@membership_cancel')->name('membership.cancel');
...
//sManager
Route::get('/smanager/success/{trnxId}', [sManagerPaymentController::class, 'success'])->name('smanager.success');
Route::get('/smanager/fail', [sManagerPaymentController::class, 'fail'])->name('smanager.fail');
