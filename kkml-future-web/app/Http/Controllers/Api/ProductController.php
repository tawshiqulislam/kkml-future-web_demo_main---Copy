...
class ProductController extends Controller
{
    public function index()
    {
        ...
        return new ProductCollection(Product::inRandomOrder(session_rand())->paginate(10));
    }
    ...
    {
        return new ProductCollection(Product::where('added_by', 'admin')->inRandomOrder(session_rand())->paginate(10));
    }

    public function seller()
    {
        return new ProductCollection(Product::where('added_by', 'seller')->inRandomOrder(session_rand())->paginate(10));
    }
    ...
    public function category($id)
    {
        ...
        return new ProductCollection(Product::whereIn('category_id', $category_ids)->inRandomOrder(session_rand())->paginate(10));
    }
    ...
    {
        return new ProductCollection(Product::where('brand_id', $id)->inRandomOrder(session_rand())->paginate(10));
    }
