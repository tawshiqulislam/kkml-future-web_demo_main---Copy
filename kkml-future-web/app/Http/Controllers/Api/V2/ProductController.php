...
class ProductController extends Controller
{
    ...
    {
        $products = \App\Product::where('published', 1)->inRandomOrder()->paginate(12);
    ...
    public function seller($id, Request $request)
    {
        ...
        return new ProductMiniCollection($products->inRandomOrder()->paginate(10));
    }
    ...
    public function category($id, Request $request)
    {
        ...
        return new ProductMiniCollection(filter_products($products)->inRandomOrder()->paginate(10));
    }
    ...
    public function subCategory($id)
    {
        ...
        return new ProductMiniCollection(Product::whereIn('category_id', $category_ids)->inRandomOrder()->paginate(10));
    }
    ...
    {
        return new ProductMiniCollection(Product::where('todays_deal', 1)->limit(20)->inRandomOrder()->get());
    }
    ...
    {
        return new ProductMiniCollection(Product::where('featured', 1)->limit(20)->inRandomOrder()->get());
    }
    ...
    public function related($id)
    {
        ...
        return new ProductMiniCollection(Product::where('category_id', $product->category_id)->where('id', '!=', $id)->limit(20)->get());
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($name != null && $name != "") {
            $products = $products->where('name', 'like', "%{$name}%")->orWhere('tags', 'like', "%{$name}%");
        }
